...
<head>
    ...
    <title>跳转提示 | {:config('web_site_title')} - LTHINK PHP</title>
...
<div class="content pulldown text-muted text-center">
    极简 · 极速 · 极致<br>
    LTHINK，让开发更简单！<br>
    由 <a class="link-effect" href="http://www.lthink.cn">LTHINK</a> 强力驱动 <a class="link-effect" href="http://www.cslb.me">橙色雷暴</a> 倾情奉献
</div>
<!-- END Error Footer -->
