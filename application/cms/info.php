...
return [
    ...
    'need_module' => [
        ['admin', 'admin.LTHINK PHP.module', '1.0.0']
    ],
    ...
    // 一般模块自带sql文件时才需要配置
    'database_prefix' => 'lthink_',

    // 模块参数配置
    'config' => [
        ['text', 'summary', '默认摘要字数', '发布文章时，如果没有填写摘要，则自动获取文档内容为摘要。如果此处不填写或填写0，则不提取摘要。', 0],
        ['ckeditor', 'contact', '联系方式', '', '<div class="font-s13 push"><strong>橙色雷暴工作室</strong><br />
地址：成都市青羊区顺城大街269号富力中心A座612<br />
邮箱：admin@cslb.me</div>'],
